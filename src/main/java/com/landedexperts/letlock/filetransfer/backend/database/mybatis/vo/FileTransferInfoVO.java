...
public class FileTransferInfoVO extends ReturnCodeMessageResponse {
    ...
    public String getFileTransferActiveCode() {
        return fileTransferInfoRecordVO.getFileTransferActiveCode();
    }

    public void setFileTransferActiveCode(String fileTransferActiveCode) {
        fileTransferInfoRecordVO.setFileTransferActiveCode(fileTransferActiveCode);
    }

    public boolean isFileTransferActive() {
        return fileTransferInfoRecordVO.isFileTransferActive();
    }

...
@Service
public class LetLockEmailServiceold {

    // Replace sender@example.com with your "From" address.
    // This address must be verified.
    static final String FROM = "letlock-notifications@landedexperts.com";
    static final String FROMNAME = "LetLock Notifications";

    // Replace recipient@example.com with a "To" address. If your account
    // is still in the sandbox, this address must be verified.
    static final String TO = "knaderi@landedexperts.com";

    // Replace smtp_username with your Amazon SES SMTP user name.
    static final String SMTP_USERNAME = "letlock-notifications@landedexperts.com";

    // Replace smtp_password with your Amazon SES SMTP password.
    static final String SMTP_PASSWORD = "7JqbmMu8ddAz3uS2YpNIWcjz7aE!";
    ...
    static final String HOST = "auth.smtp.1and1.co.uk";
    ...
    static final String BODY = String.join(System.getProperty("line.separator"), "<h1>Forgt Password?</h1>",
